...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var samSum = sum(a,b)[0] + c;
  var samProduct = multiply(a,b)[0] * c;
  var message1 = a + ' and ' + b + ' and ' + c + ' sum to ' + samSum + '.';
  var message2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + samProduct + '.';
  return[samSum, samProduct, message1, message2]
  // console.log(samSum, message1);
  // console.log(samProduct, message2);
}
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var mult2 = multiply(mult1, testArray[2]);
  var message = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + mult2 + '.';
  console.log(mult2, message);
